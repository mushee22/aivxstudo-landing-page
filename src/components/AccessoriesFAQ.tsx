...
export default function AccessoriesFAQ() {
    ...
    const faqs = [
        ...
        {
            q: "Can I scale my plan later?",
            a: "Yes, upgrade anytime."
        },
        {
            q: "Can this replace traditional shoots?",
            a: "Yes, for most ecommerce, catalogue, and ad production."
        },
        {
            q: "Do credits expire?",
            a: "Plan terms determine usage."
        },
        {
            q: "Will I own generated visuals?",
            a: "Yes, commercial usage is supported."
        },
        {
            q: "Do you offer enterprise workflows?",
            a: "Yes, with custom plans and API access."
        }
    ];
        ...
        <section id="faq" className="py-24 px-6 bg-dark-bg border-t border-white/5">
            ...
            <div className="max-w-3xl mx-auto space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400 text-lg">Everything you need to know about AI accessories photography.</p>
                </div>
