    ...
    return (
        <section className="relative w-full h-[50vh] flex items-center justify-center overflow-hidden bg-black/90">
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                <span className="text-neon-green text-sm font-medium tracking-widest uppercase mb-6 block">Our Team</span>
                ...
                <p className="text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto leading-relaxed font-light">
                    A focused team building the future of jewellery product visualization using AI.
                </p>
            </div>
        </section>
    );
