...
const results = [
    ...
    },
    {
        ...
        description: 'Elevate your brand perception with luxury-quality visuals that match premium accessory standards.',
        stat: 'Premium',
        statLabel: 'Quality',
    },
];

export default function AccessoriesCaseStudy() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8 md:mb-10">
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3">
                        Accessories Brands That Scale <span className="text-transparent bg-clip-text bg-linear-to-r from-neon-green to-emerald-400">Faster</span> with AIVX
                    </h2>
                    <p className="text-gray-400 text-base leading-relaxed max-w-2xl mx-auto">
                        Real results from accessory brands using AIVX to transform their visual content production and accelerate growth.
                    </p>
                </div>
