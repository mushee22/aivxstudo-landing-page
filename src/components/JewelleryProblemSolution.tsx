...
const problems = [
    { icon: DollarSign, label: 'High studio costs', text: '₹50K-2L per shoot session' },
    { icon: Users, label: 'Photographer + model expenses', text: '₹30K-80K additional costs' },
...
const solutions = [
    ...
    { icon: Target, label: 'CAD to luxury product visuals', text: 'Transform designs instantly', highlight: false },
    { icon: Check, label: 'Ecommerce-ready exports', text: 'Perfect for all platforms', highlight: false },
    { icon: Layers, label: 'Unlimited themes & variations', text: 'Infinite creative options', highlight: false },
...
export default function JewelleryProblemSolution() {
    return (
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                        See why brands are switching from expensive studios to AI-powered jewellery photography.
                    </p>
                </div>
