...
interface AccessoriesCategoryEcommerceProps {
    category: string;
}

export default function AccessoriesCategoryEcommerce({ category }: AccessoriesCategoryEcommerceProps) {
    const useCases = [
        {
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <p className="text-gray-400 text-lg">
                        Use AI-generated accessories images and videos seamlessly across all ecommerce platforms.
                    </p>
                </div>
