...
import { X, Check, ArrowRight, DollarSign, Clock, Sparkles, Image as ImageIcon, Zap, Users, Layers, Target, TrendingDown } from 'lucide-react';
import CTAbtn from './CTAbtn';

const problems = [
    { icon: DollarSign, label: 'High photoshoot costs', text: '₹20K-1L model booking costs' },
    { icon: Users, label: 'Model + studio expenses', text: '₹15K-50K studio rental' },
    { icon: Clock, label: 'Slow seasonal campaign launches', text: '4-6 weeks from shoot to delivery' },
    { icon: Target, label: 'Poor catalogue scalability', text: 'Limited model availability' },
    { icon: Sparkles, label: 'Inconsistent branding', text: 'Weak styling across campaigns' },
    { icon: ImageIcon, label: 'Weak ad creatives', text: 'Reduced campaign effectiveness' },
    { icon: Layers, label: 'Limited visual variations', text: 'Restricted creative options' },
    { icon: TrendingDown, label: 'Poor ecommerce presentation', text: 'Low conversion rates' },
];
...
const solutions = [
    ...
    { icon: Target, label: 'Fashion ecommerce photography', text: 'Perfect product images', highlight: false },
    { icon: Users, label: 'AI model campaigns', text: 'Indian & international models', highlight: false },
    { icon: Layers, label: 'Lifestyle/editorial shoots', text: 'Professional styling', highlight: false },
    { icon: Sparkles, label: 'Unlimited style/theme variations', text: 'Infinite creative options', highlight: false },
    { icon: DollarSign, label: 'Subscription credit packages', text: '90% cost savings', highlight: false },
    { icon: Clock, label: 'Faster collection launches', text: 'Same-day turnaround', highlight: false },
];

export default function ApparelProblemSolution() {
    return (
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                        See why fashion brands are switching from expensive model shoots to AI-powered photography.
                    </p>
                </div>
