...
export default function JewelleryFinalCTA() {
    return (
                ...
                <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <div className="max-w-3xl">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight mb-3">
                            Scale Your Jewellery Brand with{' '}
                    ...
                    <p className="text-gray-400 text-sm max-w-2xl">
                        Join 1000+ jewellery brands creating premium product photography with AI — faster, better, and at 70-90% lower cost.
                    </p>
                </div>
