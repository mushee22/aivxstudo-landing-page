...
interface AccessoriesCategoryHeroProps {
    category: string;
    backgroundImage?: string;
}

export default function AccessoriesCategoryHero({ category, backgroundImage }: AccessoriesCategoryHeroProps) {
    const displayCategory = category.charAt(0).toUpperCase() + category.slice(1);

    // Default image if none provided
    const heroImage = backgroundImage || "/image/hero/accessories/bag-3.jpg";
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-3/5 flex flex-col items-start text-left z-10">
                        ...
                        <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl leading-relaxed">
                            High-end images and product views for ecommerce, ads, and social media — without studios, props, or long shoots.
                        </p>
                    ...
                    <div className="w-full lg:w-2/5 relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-tr from-neon-green/20 to-purple-500/20 rounded-4xl blur-3xl opacity-30 transform scale-110" />
