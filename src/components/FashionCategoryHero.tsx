...
export default function FashionCategoryHero({ category, backgroundImage }: FashionCategoryHeroProps) {
    const displayCategory = category
        .split('-')
        .map((w) => w.charAt(0).toUpperCase() + w.slice(1))
        .join(' ');

    const heroImage = backgroundImage || '/image/fashion-photography-example.png';
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-3/5 flex flex-col items-start text-left z-10">
                        ...
                        <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl leading-relaxed">
                            High-end images and reel videos for ecommerce, ads, and social media — on AI models, without booking anyone.
                        </p>
                    ...
                    <div className="w-full lg:w-2/5 relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-tr from-neon-green/20 to-purple-500/20 rounded-[2rem] blur-3xl opacity-30 transform scale-110" />
