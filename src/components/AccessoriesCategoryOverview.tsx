...
interface AccessoriesCategoryOverviewProps {
    category: string;
}

export default function AccessoriesCategoryOverview({ category }: AccessoriesCategoryOverviewProps) {
    ...
    const features = [
        ...
        {
            icon: Layers,
            title: "Multiple Accessory Themes",
            desc: "Choose from various backgrounds, lighting, and lifestyle contexts."
        },
        {
            icon: Users,
            title: "Indian & International Models",
            desc: "Diverse model options styling your accessories to match your audience."
        },
        {
            icon: ShoppingBag,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <span className="text-neon-green text-sm font-medium tracking-widest uppercase mb-4 block">
                        AI Accessories Capabilities
                    </span>
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                        What We Generate for {displayCategory}
                    </h2>
                    <p className="text-gray-400 text-lg">
                        Everything you need to sell accessories online — images and videos generated using AI.
                    </p>
                </div>
