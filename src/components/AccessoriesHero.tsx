            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="space-y-8 z-10 order-2 lg:order-1">
                    ...
                    <p className="text-lg text-neutral-400 max-w-xl leading-relaxed font-light">
                        Create studio-quality accessories images using AI — faster, scalable, and cost-effective.
                    </p>
                ...
                <div className="relative h-[350px] sm:h-[450px] md:h-[600px] w-full grid grid-cols-2 gap-4 order-1 lg:order-2">
                    {[
                        { src: "/image/hero/accessories/bag-3.jpg", alt: "Bag" },
                        { src: "/image/hero/accessories/watch-4.jpg", alt: "Watch" },
                        { src: "/image/hero/accessories/perfume-4.jpg", alt: "Perfume" },
                        { src: "/image/hero/accessories/cosmetic-1.jpg", alt: "Cosmetics" },
                        { src: "/image/hero/accessories/bag-2.jpg", alt: "Bag Alternative" },
                        { src: "/image/hero/accessories/watch-2.jpg", alt: "Watch Alternative" },
                    ].map((item, index) => (
                        <div
                            key={index}
