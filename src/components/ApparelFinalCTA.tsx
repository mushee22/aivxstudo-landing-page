...
export default function ApparelFinalCTA() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <p className="text-gray-400 text-sm max-w-2xl">
                        Join 1000+ fashion brands creating professional model photography with AI — faster, scalable, and at 70-90% lower cost.
                    </p>
                </div>
