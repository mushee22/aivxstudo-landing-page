...
interface AccessoriesCategoryAspectRatiosProps {
    category: string;
}

export default function AccessoriesCategoryAspectRatios({ category }: AccessoriesCategoryAspectRatiosProps) {
    const ratios = [
        {
            label: "Square (1:1)",
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <p className="text-gray-400 text-lg">
                        Generate accessories images and videos optimized for every platform.
                    </p>
                </div>
