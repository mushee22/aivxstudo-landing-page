...
interface AccessoriesCategoryFAQProps {
    title: string;
    faqs: FAQItem[];
}

export default function AccessoriesCategoryFAQ({ title, faqs }: AccessoriesCategoryFAQProps) {
        ...
        <section id="faq" className="py-24 px-6 bg-dark-bg border-t border-white/5">
            ...
            <div className="max-w-3xl mx-auto space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400 text-lg">Frequently asked questions about category-specific shoots.</p>
                </div>
