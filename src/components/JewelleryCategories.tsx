...
const categories = [
    { name: 'Ring', href: '/product-shoot/jewellery/ring', color: 'from-rose-500/20 to-orange-500/20' },
    { name: 'Ear Ring', href: '/product-shoot/jewellery/ear-ring', color: 'from-purple-500/20 to-indigo-500/20' },
    { name: 'Pendant Set', href: '/product-shoot/jewellery/pendant-set', color: 'from-blue-500/20 to-cyan-500/20' },
    { name: 'Necklace', href: '/product-shoot/jewellery/necklace', color: 'from-emerald-500/20 to-teal-500/20' },
    { name: 'Necklace Set', href: '/product-shoot/jewellery/necklace-set', color: 'from-amber-500/20 to-yellow-500/20' },
    { name: 'Bangle', href: '/product-shoot/jewellery/bangle', color: 'from-pink-500/20 to-rose-500/20' },
];
