...
import { TrendingDown, Zap, CheckCircle2, TrendingUp, Award, Layers, Target } from 'lucide-react';
...
const results = [
    {
        ...
        description: 'Eliminate model bookings, studio rentals, and photographer fees while scaling your fashion campaigns.',
        stat: '70–90%',
        statLabel: 'Cost Reduction',
    },
    {
        icon: Zap,
        title: 'Faster seasonal launches',
        description: 'Launch collections in days instead of weeks with AI model photography and instant variations.',
        stat: '10X',
        statLabel: 'Faster',
    },
    {
        ...
        description: 'Maintain consistent visual quality across all products, marketplaces, and marketing channels.',
        stat: '100%',
        statLabel: 'Consistency',
    },
    {
        icon: TrendingUp,
        title: 'Increased ad performance',
        description: 'Test unlimited creative variations and improve campaign ROI with diverse AI model shots.',
        stat: '3X',
    ...
    },
    {
        ...
        description: 'Build cohesive brand aesthetics with consistent styling, models, and visual language.',
        stat: '↑40%',
        statLabel: 'Brand Recognition',
    },
    {
        icon: Layers,
        title: 'Scalable catalogue production',
        description: 'Scale from 100 to 10,000 product shots without proportional increases in time or budget.',
        stat: 'Unlimited',
    ...
    },
    {
        ...
        description: 'Elevate brand perception with luxury-quality visuals that match premium fashion standards.',
        stat: 'Premium',
        statLabel: 'Quality',
    },
];

export default function ApparelCaseStudy() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8 md:mb-10">
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3">
                        Fashion Brands That Scale <span className="text-transparent bg-clip-text bg-linear-to-r from-neon-green to-emerald-400">Faster</span> with AIVX
                    </h2>
                    <p className="text-gray-400 text-base leading-relaxed max-w-2xl mx-auto">
                        Real results from fashion brands using AIVX to transform their visual content production and accelerate growth.
                    </p>
                </div>
